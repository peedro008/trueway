  ...
  if (loading === false) {
    ...
    return (
      <Router>
        ...
        <Route
          exact
          path="/management/DealerSalePerson"
          component={ManagementDealerSalePerson}
        />
        <Route exact path="/management/Client" component={ManagementClient} />
        <Route
          exact
          path="/management/Location"
          component={ManagementLocation}
        />
        <Route
          exact
          path="/management/Producer"
          component={ManagementProducer}
        />
        ...
        <Route
          exact
          path="/report/Deleted/payments"
          component={DeletedPayments}
        />
        <Route
          exact
          path="/report/Deleted/clients"
          component={DeletedClients}
        />
        <Route
          exact
          path="/report/Deleted/Managers"
          component={DeletedManagers}
        />
        <Route
          exact
          path="/report/Deleted/Producers"
          component={DeletedProducers}
        />
        <Route exact path="/users/manager/details" component={ManagerDetails} />
        <Route
          exact
          path="/users/producers/details"
