      ...
      <div className="REPcontrol">
          <div className="REPDate">
             ...
             }
             {
             ...
             }
              {
                 ...
                 <div className="cloudFilter">
                     <p className="cloudFilterText">Dealer name:{Dealers.find(c => c.id ==  filterValues.DealerSalePersonId).name}
                     
                     </p>
                     <img src={close} style={{marginLeft:"5px"}} onClick={()=>{closeCloud({...filterValues,DealerSalePersonId:null})}}/>
                     </div>
             }
              ...
              Dealers.sort(function (a, b) {
                ...
                return (
                  <tr>
                    ...
                    >
                    {!e.paid  && <><FaRegMoneyBillAlt style={{cursor:"pointer"}} onClick={()=>{handleOpenModal(e)}} color="#14B8A6" size="20px" /></>}
                    </td>
                  </tr>
                );
              })
        ...
        <div className="FilterCom">
            ...
            <div className="FilterComRow">
                <input type={"checkbox"} checked={filterCheck.datePaid} onChange={(e)=>setFilterCheck({
            ...
            </div>
            {
                ...
                <div className="FilterComRow"><input type="date"  onChange={(e)=>setFilterValues({...filterValues, dateTo:e.target.value})}  className="PAYselect" style={{border:"1px solid #D6E4EC", padding:"5px"}}/></div>
                 ...
                 <div className="FilterComRow">
                <input type={"checkbox"} checked={filterCheck.dateSold} onChange={(e)=>setFilterCheck({
            ...
            </div>
            {
                ...
                <>
                <p className="REPtype"style={{marginLeft:"15px",color:"black", fontWeight:700}}>From</p>
                <div className="FilterComRow"><input type="date"  onChange={(e)=>setFilterValues({...filterValues, dateFrom1:e.target.value})}  className="PAYselect" style={{border:"1px solid #D6E4EC", padding:"5px"}}/></div>
                <p className="REPtype" style={{marginLeft:"15px",color:"black", fontWeight:700}}>to</p>
                <div className="FilterComRow"><input type="date"  onChange={(e)=>setFilterValues({...filterValues, dateTo1:e.target.value})}  className="PAYselect" style={{border:"1px solid #D6E4EC", padding:"5px"}}/></div>
                </>
            }
            ...
            </div>
            {
               ...
               <div className="FilterComRow">
                <input type={"checkbox"}checked={filterCheck.DealerSalePersonId} onChange={(e)=>setFilterCheck({ 
            ...
            </div>
            {
                ...
                <div className="FilterComRow"><Select options={dealerSalePerson.map(e=>({value:e.id,label:e.name}))} onChange={(e)=>setFilterValues({...filterValues, DealerSalePersonId:e.value})}  className="PAYselect"/></div>
            }
        ...
        <Modal open={open} onClose={onCloseModal} center classNames={"modal"} >
                    ...
                    <FaRegMoneyBillAlt color="#14B8A6" size={"50px"} style={{alignSelf:"center", marginTop:"25px", marginBottom:"10px"}}/>
                    <p className="modalText">Type "pay" to confirm </p>
                    <input className='AQinput' onChange={(e)=>setModalPay(e.target.value)} style={{marginTop:"12px"}}/>
                
                    <button disabled={modalPay=="pay"?false:true} className="modalButton" onClick={handlePayModal}>Continue</button>
